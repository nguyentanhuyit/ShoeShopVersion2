...
namespace Shoe
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IContactDAO, ContactDAOImp>();
            services.AddTransient<IContactService, ContactServiceImp>();
            services.AddTransient<INewsletterDAO, NewsletterDAOImp>();
            services.AddTransient<INewsletterService, NewsletterServiceImp>();
            services.AddTransient<IShoeSizeDAO, ShoeSizeDAOImp>();
            services.AddTransient<IShoeSizeService, ShoeSizeServiceImp>();
            services.AddTransient<IRoleDAO, RoleDAOImp>();
            services.AddTransient<IRoleService, RoleServiceImp>();
