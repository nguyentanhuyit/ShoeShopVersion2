...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseMySql("server=localhost;port=3306;user=root;database=shoeshop", Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.4.14-mariadb"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CartItem>(entity =>
            {
                ...
                entity.HasIndex(e => e.ShoeSizeId, "fk_cartItem_3");
                ...
                entity.HasOne(d => d.ShoeSize)
                    ...
                    .HasConstraintName("fk_cartItem_3");
            ...
            modelBuilder.Entity<Newsletter>(entity =>
            {
                ...
                entity.Property(e => e.Subcribe)
                    .HasColumnName("subcribe");
